...
INSERT INTO tbl_menu VALUES (category_code null,category_code )
...
INSERT INTO tbl_order (order_code, order_date, order_time, total_order_price) VALUES
(1, '2024-12-24', '17:00:00', 14000),
(2, '2024-12-24', '18:30:00', 22000),
(3, '2024-12-25', '13:45:00', 55000),
(4, '2024-12-25', '14:00:00', 4000),
(5, '2024-12-25', '15:15:00', 34000);

-- INSERT statements for tbl_order_menu
INSERT INTO tbl_order_menu (order_code, menu_code, order_amount) VALUES
(1, 1, 2),
(1, 2, 1),
(2, 20, 1),
(3, 5, 1),
...
-- INSERT statements for tb` bmnml_payment
INSERT INTO tbl_payment (payment_code, payment_date, payment_time, payment_price, payment_type) VALUES
(1, '20241224', '17:30:00', 14000, 'CARD'),
(2, '20241224', '20:00:00', 11000, 'CASH'),
(3, '20241224', '20:01:00', 11000, 'CARD'),
(4, '20241225', '14:00:00', 55000, 'CARD'),
(5, '20241225', '15:30:00', 38000, 'CARD');

-- INSERT statements for tbl_payment_order
INSERT INTO tbl_payment_order (order_code, payment_code) VALUES
(1, 1),
(2, 2), # 하나의 주문을 여러번 나눠 결제
(2, 3), # 하나의 주문을 여러번 나눠 결제
(3, 4),
(4, 5), # 여러주문 동시 결제
(5, 5); # 여러주문 동시 결제
